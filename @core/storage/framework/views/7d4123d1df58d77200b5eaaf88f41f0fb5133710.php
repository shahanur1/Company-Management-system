            ...
            <div class="col-lg-6 mt-5">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.form.builder.get.in.touch')); ?>" method="Post">
                            <?php echo csrf_field(); ?>
                            <?php echo render_drag_drop_form_builder_markup(get_static_option('get_in_touch_form_fields')); ?>
                    ...
                    <div class="card-body">
                        ...
                        <ul id="sortable_02" class="available-form-field">
                            ...
                            <li class="ui-state-default" type="date"><span
                                        class="ui-icon ui-icon-arrowthick-2-n-s"></span><?php echo e(__('Date')); ?></li>
                        </ul>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/smshaju/public_html/for_FTP/@core/resources/views/backend/form-builder/get-in-touch-form.blade.php ENDPATH**/ ?>