                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="visibility" class="form-control">
                                            <option <?php if($page_post->visibility): ?> selected <?php endif; ?> value="all"><?php echo e(__('All')); ?></option>
                                            <option <?php if($page_post->visibility): ?> selected <?php endif; ?> value="user"><?php echo e(__('Only Logged In User')); ?></option>
                                        </select>
                                    </div>
                                    <div class="form-group">
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/smshaju/public_html/for_FTP/@core/resources/views/backend/pages/page/edit.blade.php ENDPATH**/ ?>